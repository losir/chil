<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/myAdmin.master" AutoEventWireup="true" CodeFile="admin_Order_ProcessNO.aspx.cs" Inherits="admin_admin_orderList" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">

        <img src="images/admin_order_nok.png" style="width: 810px; height: 45px" /></p>
...
&nbsp;&nbsp;&nbsp;
    ...
    <p>
        <asp:AccessDataSource ID="order_list" runat="server" 
            ...
            SelectCommand="SELECT [no], buyname, buytel, buyaddr, buyemail, pay, gotime, recall FROM ordergoods WHERE (buyname LIKE '%' + ? + '%') AND (recall = false) AND (buytel LIKE '%' + ? + '%') ORDER BY [no] DESC">
            <SelectParameters>
